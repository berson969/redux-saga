...
1. [Поиск](/src/Search/README.md).
1. [Список и подробности]().
1. [Лента новостей]() — необязательная задача.
...
1. Откройте терминал и пропишите следующую команду: `yarn create vite my-app --template react-ts`,
